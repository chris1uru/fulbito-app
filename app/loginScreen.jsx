    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#17191C" }}>
      ...
      >
        <View className="mb-9 items-center">
          ...
          <Text className="mt-2 text-sm text-[#A9B1B8]">Tu próxima cancha está más cerca</Text>
        </View>

        <View className="rounded-3xl border border-[#30363D] bg-[#202428] p-5">
          <Text className="text-2xl font-semibold text-white">¡Hola de nuevo!</Text>
          <Text className="mb-7 mt-1 text-sm text-[#A9B1B8]">Ingresá a tu cuenta para seguir jugando</Text>

          <Text className="mb-2 text-sm font-medium text-[#C5CBD1]">Correo electrónico</Text>
          ...
          <Text className="mb-2 text-sm font-medium text-[#C5CBD1]">Contraseña</Text>
          ...
          <TouchableOpacity
            ...
            onPress={handleLogin}
          >
            <Text className="mr-2 font-semibold text-[#152012]">{loading ? "Ingresando..." : "Iniciar sesión"}</Text>
        ...
        <Link href="/register" asChild>
          <TouchableOpacity className="mt-6 items-center py-2">
            <Text className="text-[#A9B1B8]">
              ¿No tenés cuenta? <Text className="font-semibold text-[#80D160]">Registrate</Text>
            </Text>
          </TouchableOpacity>
        </Link>
      </ScrollView>
